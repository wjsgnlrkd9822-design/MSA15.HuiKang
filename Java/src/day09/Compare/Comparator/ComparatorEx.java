...
public class ComparatorEx {
	...
	public static void main(String[] args) {
		List<Product> productList = Arrays.asList(
			...
			new Product("PRD001", "바지", 40000),
			new Product("PRD001", "패딩", 100000),
			new Product("PRD001", "셔츠", 15000),
			new Product("PRD001", "우유", 4000),
			new Product("PRD001", "젤리", 4000)
		);
